  ...
  inline auto get_storage() const {
    ...
    return sqlite_orm::make_storage(
        ...
        sqlite_orm::make_table(
            ...
            sqlite_orm::make_column(
                "access_keys_secret", &DBUser::access_keys_secret
            ),
            ...
            sqlite_orm::make_column(
                "user_version_tag", &DBUser::user_version_tag
            )
        ),
        sqlite_orm::make_table(
            ...
            sqlite_orm::make_column(
                "placement_name", &DBBucket::placement_name
            ),
            sqlite_orm::make_column(
        ...
        sqlite_orm::make_table(
            ...
            sqlite_orm::make_column(
                "delete_at_time", &DBObject::delete_at_time
            ),
